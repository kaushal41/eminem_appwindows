...
{
    /// <summary>
    /// Fake suitsCollectionSchema data source.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public class Fakecostumes_suitsCollection : Icostumes_suitsCollection 
    {
        ...
        public ObservableCollection<Entities.suitsCollectionSchema> GetData(int pageNumber = 0)
	
        {			
            var data = new ObservableCollection<Entities.suitsCollectionSchema> 
			{ 
			...
			return new ObservableCollection<Entities.suitsCollectionSchema>(data.Skip(MaxResults * pageNumber).Take(MaxResults));
        ...
        public ObservableCollection<Entities.suitsCollectionSchema> Refresh(int pageNumber = 0)
		...
		/// <summary>
        /// Retrieves the data from a fake, filtered by a filter specification, in an observable collection of suitsCollectionSchema items.
        /// </summary>
        ...
        {			
			return RepositoriesBase.Filter<Entities.suitsCollectionSchema>.FilterCollection(filter, GetData());
        }
