...
{
    /// <summary>
    /// Phone application page for costumes_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class costumes_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for costumes_Detail and all its components.
        /// </summary>
        public costumes_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("Panoramacostumes_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["Panoramacostumes_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramacostumes_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramacostumes_Detail(Panoramacostumes_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramacostumes_Detail(PanoramaItem panoramaItem)        
        {
        ...
        private void AddHomeAppBarButton()
        {
			...
			{ 
				new Ioc.Container().Resolve<IServices.INavigationService>().NavigateTo<IViewModels.Ihistory_InterestingfactsViewModel>(); 
