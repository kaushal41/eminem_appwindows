...
namespace WPAppStudio.Ioc
{
    ...
    public class Container : IIoc.IContainer
    {
        ...
        public Container()
        {
            ...
            _currentContainer.RegisterType<IViewModels.Ihistory_InterestingfactsViewModel, ViewModels.history_InterestingfactsViewModel>();
            _currentContainer.RegisterType<IViewModels.Icostumes_DetailViewModel, ViewModels.costumes_DetailViewModel>();
            ...
            {
				_currentContainer.RegisterType<Repositories.Ihistory_story, Repositories.history_story>(new ContainerControlledLifetimeManager());
				_currentContainer.RegisterType<Repositories.Icostumes_suitsCollection, Repositories.costumes_suitsCollection>(new ContainerControlledLifetimeManager());
			}
			else
			{
				_currentContainer.RegisterType<Repositories.Ihistory_story, Repositories.Fakehistory_story>(new ContainerControlledLifetimeManager());
				_currentContainer.RegisterType<Repositories.Icostumes_suitsCollection, Repositories.Fakecostumes_suitsCollection>(new ContainerControlledLifetimeManager());
