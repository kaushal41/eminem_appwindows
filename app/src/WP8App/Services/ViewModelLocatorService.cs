...
namespace WPAppStudio.Services
{
    ...
    public class ViewModelLocatorService
    {
        ...
        /// <summary>
        /// Gets the reference to a history_InterestingfactsViewModel.
        /// </summary>
		public IViewModels.Ihistory_InterestingfactsViewModel history_InterestingfactsViewModel
        {
            get { return _container.Resolve<IViewModels.Ihistory_InterestingfactsViewModel>(); }
        }

        /// <summary>
        /// Gets the reference to a costumes_DetailViewModel.
        /// </summary>
		public IViewModels.Icostumes_DetailViewModel costumes_DetailViewModel
        {
            get { return _container.Resolve<IViewModels.Icostumes_DetailViewModel>(); }
        }
		/// <summary>
