...
namespace WPAppStudio.Services
{
    ...
    public class NavigationService : ServicesInterfaces.INavigationService
    {
        ...
        {
            { typeof(IViewModels.Ihistory_InterestingfactsViewModel), "/View/history_Interestingfacts.xaml" },
            { typeof(IViewModels.Icostumes_DetailViewModel), "/View/costumes_Detail.xaml" },
