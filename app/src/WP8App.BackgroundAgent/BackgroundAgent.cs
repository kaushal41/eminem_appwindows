...
namespace WPAppStudio.BackgroundProcess
{
    public class BackgroundAgent : ScheduledTaskAgent
    {
        ...
        protected  void UpdateCycleTileData()
        {
            ...
            var costumes_suitsCollection = backgroundContainer.Resolve<Icostumes_suitsCollection>();
			var costumes_suitsCollectionItems = new List<suitsCollectionSchema>();
			var costumes_suitsCollectionData =  costumes_suitsCollection.GetData();
			costumes_suitsCollectionItems.AddRange(costumes_suitsCollectionData);
            newImagesFiles.AddRange(costumes_suitsCollectionItems.Select(i => i.Image).ToList());
